...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "yF5X2AJY#ysxLkBHG34DlZBF1Y6ty1XhvaVhnOG3_Yw64rf7mWFI", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94761259370",
DEV: process.env.DEV || "94761259370",
